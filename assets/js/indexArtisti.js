...
async function retrieveArtist() {
    try {
        ...
        sfondoSezioneCentrale.innerHTML += `<img class="imgAlbumCover" src="${myJsonArtist.picture_big}" alt="Artist Cover">`;

        sideContent.innerHTML = "";
        sideContent.innerHTML = `
        <div>
        <img src="${myJsonArtist.picture_small}" alt="" class="rounded-circle me-3">
      </div>
      <div d-flex align-items-center>
        <p class="fw-bold mb-0">Hai messo mi piace a 11 brani</p>
        <p class="fw-light nomeArtista">Di ${myJsonArtist.name}</p>
      </div>`
